...
(0, vitest_1.describe)("Objects", () => {
    (0, vitest_1.describe)("diff", () => {
        ...
        (0, vitest_1.it)("solves #219", () => {
            const objBefore = { config: { numbers: [1] } };
            const objAfter = { config: { numbers: [{ value: 1, decimalPlaces: 0, unit: "mm" }] } };
            (0, vitest_1.expect)((0, Objects_1.diff)(objBefore, objAfter)).toEqual({
                config: {
                    numbers: [{ from: 1, decimalPlaces: { to: 0 }, unit: { to: "mm" }, value: { to: 1 } }],
                },
            });
            (0, vitest_1.expect)(JSON.stringify((0, Objects_1.diff)(objBefore, objAfter, "from"), null, 2)).toEqual(JSON.stringify({
                config: { numbers: [{ decimalPlaces: undefined, unit: undefined, value: undefined }] },
            }, null, 2));
            (0, vitest_1.expect)((0, Objects_1.diff)(objBefore, objAfter, "to")).toEqual({
                config: {
